...
__LBB2_39:                              # %if.else94
	...
	blt	__LBB2_44
	br	__LBB2_40
__LBB2_40:                              # %for.body111.preheader
                                        #   in Loop: Header=BB2_12 Depth=1
	ldi	r1, 0
__LBB2_41:                              # %for.body111
                                        #   Parent Loop BB2_12 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add	r2, fp, r2
	ldb	r2, r1, r2
...
__LBB2_44:                              # %cleanup123
	...
	beq	__LBB2_49
	br	__LBB2_45
__LBB2_49:                              # %if.else141
                                        #   in Loop: Header=BB2_12 Depth=1
	ldi	r0, 2
	cmp	r3, r0
	bne	__LBB2_52
	br	__LBB2_50
__LBB2_50:                              # %if.then144
                                        #   in Loop: Header=BB2_12 Depth=1
	ldi	r0, _random+1
	ldi	r1, 0
	stb	r0, r1
...
__LBB2_45:                              # %if.then129
	...
	bne	__LBB2_47
	br	__LBB2_46
__LBB2_46:                              # %if.then133
                                        #   in Loop: Header=BB2_12 Depth=1
	ldi	r0, 0
	stb	r2, r0
	br	__LBB2_52
__LBB2_47:                              # %if.else134
                                        #   in Loop: Header=BB2_12 Depth=1
	ldi	r1, _random+1
	ldsb	r1, r1
	cmp	r0, r1
	bne	__LBB2_52
	br	__LBB2_48
__LBB2_48:                              # %if.then138
                                        #   in Loop: Header=BB2_12 Depth=1
	ldi	r0, _random+1
	ldi	r1, 0
	stb	r0, r1
	br	__LBB2_52
__LBB2_51:                              # %if.else148
                                        #   in Loop: Header=BB2_12 Depth=1
	ldi	r0, __L.str.11
	jsr	print_to_tty
	lsw	r3, -18                         # 2-byte Folded Reload
