...
__LBB2_12:                              # %while.body.lr.ph.split
...
__LBB2_23:                              # %for.body.lr.ph
	...
	beq	__LBB2_25
	br	__LBB2_24
__LBB2_25:                              # %for.body.lr.ph.split.us
                                        #   in Loop: Header=BB2_12 Depth=1
	ldi	r0, 2
	cmp	r4, r0
	beq	__LBB2_27
	br	__LBB2_26
__LBB2_27:                              # %for.body.us.us
                                        #   in Loop: Header=BB2_12 Depth=1
	lsb	r0, -12
	cmp	r0, r5
	movens	r6, r0
...
__LBB2_43:                              # %if.else100
	...
	blt	__LBB2_48
	br	__LBB2_44
__LBB2_44:                              # %for.body117.preheader
                                        #   in Loop: Header=BB2_12 Depth=1
	movens	r6, r1
__LBB2_45:                              # %for.body117
                                        #   Parent Loop BB2_12 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add	r3, fp, r2
	ldb	r2, r1, r2
...
__LBB2_40:                              # %if.then95
	...
	jsr	move_checker
	br	__LBB2_56
__LBB2_24:                              # %for.body.preheader
                                        #   in Loop: Header=BB2_12 Depth=1
	ldi	r0, 255
	and r5, r0, r1
	movens	r6, r0
	br	__LBB2_32
__LBB2_36:                              # %for.inc.sink.split
...
__LBB2_53:                              # %if.else148
	...
	bne	__LBB2_56
	br	__LBB2_54
__LBB2_54:                              # %if.then151
                                        #   in Loop: Header=BB2_12 Depth=1
	ldi	r0, _random+1
	stb	r0, r6
	ldi	r4, 2
	br	__LBB2_56
__LBB2_49:                              # %if.then136
                                        #   in Loop: Header=BB2_12 Depth=1
	ldi	r2, _random
	ldsb	r2, r1
	cmp	r0, r1
	...
	bne	__LBB2_51
	br	__LBB2_50
__LBB2_50:                              # %if.then140
                                        #   in Loop: Header=BB2_12 Depth=1
	stb	r2, r6
	br	__LBB2_56
__LBB2_51:                              # %if.else141
                                        #   in Loop: Header=BB2_12 Depth=1
	ldi	r1, _random+1
	ldsb	r1, r1
	cmp	r0, r1
	bne	__LBB2_56
	br	__LBB2_52
__LBB2_52:                              # %if.then145
                                        #   in Loop: Header=BB2_12 Depth=1
	ldi	r0, _random+1
	stb	r0, r6
	br	__LBB2_56
__LBB2_26:                              # %for.body.us.preheader
                                        #   in Loop: Header=BB2_12 Depth=1
	movens	r6, r0
	br	__LBB2_30
__LBB2_30:                              # %for.body.us
                                        #   Parent Loop BB2_12 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldi	r1, -12
	add	r1, fp, r1
	...
	beq	__LBB2_33
	br	__LBB2_31
__LBB2_31:                              # %if.end54.us
                                        #   in Loop: Header=BB2_30 Depth=2
	add	r0, 1
	cmp	r4, r0
	beq	__LBB2_56
	br	__LBB2_30
__LBB2_29:                              # %if.end54.us.us.1
                                        #   in Loop: Header=BB2_12 Depth=1
	ldi	r0, _random+1
	stb	r0, r6
	ldi	r4, 2
	br	__LBB2_56
__LBB2_55:                              # %if.else155
                                        #   in Loop: Header=BB2_12 Depth=1
	ldi	r0, __L.str.12
	jsr	PrintToTTY
__LBB2_56:                              # %if.end157
